...
namespace projectoFinal.DAL_SQLite
{
    ...
    {
        Models.carBrand _CarBrandCC;
        public Models.carBrand CarBrandCC
        {
            get { return this._CarBrandCC; }
            set { this._CarBrandCC = value; }
        }
        ...
        public (string error, List<Models.carBrand>) selectCarBrandAll()
        {
            ...
            bool.Parse(reader["active"].ToString())
                ...
                {
                    String mensagem = "selectCarBrandActive CarBrand" + Environment.NewLine + ex.Message;
        ...
        public (int codigo, string erro) updateCarBrand()
        {
            carregarLerLigacaoBD();
            if (ligacao.Length == 0)
            {
            ...
            else
            {
                ...
                {
                    return (0, "insertCarBrand CarBrand" + Environment.NewLine + ex.Message);
                }
            }
        }
        ...
        public string selectIdByName(string descriptionBrand)
        {
            ...
            else
            {
                ...
                {
                    String mensagem = "selectIdByName CarBrand" + Environment.NewLine + ex.Message;
                    return "0";
                }
            }
        ...
        public (int codigo, string erro) insertCarBrand()
        {
            carregarLerLigacaoBD();
            if (ligacao.Length == 0)
            {
        ...
        public (int codigo, string erro) deleteCarBrand()
        {
            carregarLerLigacaoBD();
            if (ligacao.Length == 0)
            {
