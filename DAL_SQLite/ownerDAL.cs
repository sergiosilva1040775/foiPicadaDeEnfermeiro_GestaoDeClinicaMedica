...
namespace projectoFinal.DAL_SQLite
{
    ...
    {
        Models.owner  _ownerCC;
        public Models.owner  ownerCC
        {
            get { return this._ownerCC; }
            set { this._ownerCC = value; }
        }
        ...
        private void carregarLerLigacaoBD()
        {
            ...
            {
                String mensagem = "carregarLerLigacaoBD ownerDAL" + Environment.NewLine + ex.Message;
                ligacao = "";
            }
        ...
        public (int codigo, string erro) updateOwner()
        {
            carregarLerLigacaoBD();
            if (ligacao.Length == 0)
            {
            ...
            //        catch (Exception ex)
            //        {
            return (0, "updateOwner ownerDAL");
            //        return (0, "updateOwner ownerDAL" + Environment.NewLine + ex.Message);
            //        }
            //    }
        }
            ...
            public (int codigo, string erro) insertOwner()
        {
            carregarLerLigacaoBD();
            if (ligacao.Length == 0)
            {
        ...
        public (int codigo, string erro) deleteOwner()
        {
            carregarLerLigacaoBD();
            if (ligacao.Length == 0)
            {
            ...
            //        catch (Exception ex)
            //        {
            return (0, "deleteCarBrand ownerDAL");
            //            return (0, "deleteCarBrand ownerDAL" + Environment.NewLine + ex.Message);
            //        }
            //    }
            //}
        }
